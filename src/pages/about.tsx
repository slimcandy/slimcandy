        ...
        <dl>
          <div className="row">
            ...
            >
              ...
              <ul>
                ...
                <li>
                  created and maintained internal ui library components
                  (semantic code, speed optimization, legacy code refactoring),
                </li>
                <li>
          ...
          <div className="row">
            ...
            >
              ...
              <ul>
                <li>
                  Created dynamic HTML email templates in CRM - mjml, twig,
                </li>
                <li>
                  Created landing pages to BEM, bootstrap, webpack + babel and
                  redesigned them by mobile first - vanilla js, rest, google
                  page speed to the green zone.
                </li>
              </ul>
              <p>React components:</p>
              <ul>
                <li>
                  Drag&apos;n&apos;Drop upload with intelligent tagging (the
                  category is taken from the folder structure and file name),
                </li>
          ...
          <div className="row">
            ...
            >
              ...
              <ul>
                ...
                <li>
                  created dozens of components (HTML emails, links to
                  rapidmail),
                </li>
