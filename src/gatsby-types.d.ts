...
type SinglePostLayoutQueryVariables = Exact<{
  ...
  nextSlug: InputMaybe<Scalars['String']>;
}>;


type SinglePostLayoutQuery = { readonly sanityPost: { readonly id: string, readonly youtubeUrl: string | null, readonly title: string | null, readonly description: string | null, readonly publishedAt: string | null, readonly _rawContent: Record<string, unknown> | null, readonly mainImage: { readonly asset: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData, readonly altText: string | null } | null } | null, readonly category: { readonly name: string | null } | null, readonly author: { readonly name: string | null } | null } | null, readonly prevPost: { readonly title: string | null, readonly description: string | null, readonly slug: { readonly current: string | null } | null } | null, readonly nextPost: { readonly title: string | null, readonly description: string | null, readonly slug: { readonly current: string | null } | null } | null, readonly site: { readonly siteMetadata: { readonly title: string | null, readonly description: string | null, readonly motto: string | null, readonly social: { readonly github: string | null, readonly linkedin: string | null, readonly youtube: string | null } | null } | null } | null };
