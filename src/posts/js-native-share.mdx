...
In the beginning was the share widgets - [AddToAny](https://www.addtoany.com), [AddThis](https://www.addthis.com) and [ShareThis](https://sharethis.com). User clicks the social network logo and it opens popup window that requires authentication.

Then came smartphones with embedded share option.

Recently JS came out with this native support.

## Motivation

No auth services needed. Native sharing.
